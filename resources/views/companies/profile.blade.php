...
<head>
    ...
    <link rel='stylesheet' type='text/css' media='screen' href='/css/views/companies/profile.css'>    
    <script src="/js/views/companies/profile.js"></script>
...
<body>
            ...
            <div class="d-flex">
                <div class="hamburger-menu">
                    ...
                    <ul class="menu_box bold">
                        ...
                        <li><a href="{{ route('bkk.profile')}}" class="menu_item"><i class="fas fa-user-lock">&nbsp;</i> Login</a></li>
                        <li><a href="{{ route('bkk.profile')}}" class="menu_item"><i class="fas fa-clipboard-list">&nbsp;</i> Daftar</a></li>
    ...
    <div class="container">
        <div class="profile-heads mb-4 bg-white p-2 py-5 p-md-5 borad-20 position-relative">
        <!-- justify-content-end -->
                <div class="d-flex justify-content-center justify-content-md-start" style="filter: drop-shadow(10px 10px 10px rgba(0,0,0,0.1));"> 
                    <div class="col-7 col-md-3 card-img-profile bg-white d-flex m-auto position-absolute justify-content-center"
                        style="top: -8rem;">
                        <img src="/assets/images/companies/logo-smk2.svg" width="200em" height="200em" class="m-auto">
                    </div>
                </div>
            <div class="row justify-content-end mx-auto mt-5 m-md-auto pt-5 p-md-3">
                <div class="col-12 col-md-6 text-center text-md-left">
                    <h3>BKK Surakarta</h3>
                    <h5 class="blue-dot d-flex justify-content-center justify-content-md-start">Sekolah</h5>
                </div>
                <div class="col-12 col-md-3 d-flex">
                    <div class="col-6 col-md-12 btn btn-info btn-edit-profile m-auto d-flex p-2">
                        <h5 class="m-auto text-white">Edit Profile</h5>
                    </div>
                </div>
            </div>
            <div class="row m-auto p-2">
                <div class="row col-4 p-3 d-flex border-l-blue m-auto">
                    <h3 class="col-12 m-auto">Since</h3>
                    <h5 class="col-12 m-auto">2017</h5>
                </div>
                <div class="row col-4 p-3 d-flex border-l-blue m-auto">
                    <h3 class="col-12 m-auto">Email</h3>
                    <h5 class="col-12 m-auto">nikerja@gmail.com</h5>
                </div>
                <div class="row col-4 p-3 d-flex border-l-blue m-auto">
                    <h3 class="col-12 m-auto">Website</h3>
                    <h5 class="col-12 m-auto">nikerja.com</h5>
                </div>
            </div>        
        </div>
